...
func TestGeneratedFileCompilesAndRuns(t *testing.T) {
	...
	write(t, filepath.Join(dir, "go.mod"), `module repro

go 1.26

require github.com/tmc/fuzztape v0.0.0

replace github.com/tmc/fuzztape => `+root+"\n")
...
func moduleRoot() (string, error) {
	...
	return filepath.Dir(dir), nil // the trace package sits one level down
}
